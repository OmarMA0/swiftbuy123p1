...
<template>
    <div class="sticky top-0 z-50 flex flex-wrap bg-[#242423] justify-center items-center gap-2 md:gap-4 lg:gap-20 w-full text-white border-1 rounded border-[#f5cb5c] p-2">
